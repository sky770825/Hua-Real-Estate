...
function renderInviteEvent(data) {
    ...
    if (eventGrid && event['E圖片1網址'] && event['F圖片2網址']) {
        // 🚀 移除骨架屏，顯示實際內容
        eventGrid.classList.add('content-loaded');
        
        eventGrid.innerHTML = `
            <div class="event-card" onclick="openModal('${event['E圖片1網址']}')">
                <img src="${event['E圖片1網址']}" alt="專講預告 1" class="event-image" loading="lazy">
                <div class="event-overlay">
                    <span class="event-icon">🔍</span>
                    <p>點擊放大</p>
                </div>
            </div>
            <div class="event-card" onclick="openModal('${event['F圖片2網址']}')">
                <img src="${event['F圖片2網址']}" alt="專講預告 2" class="event-image" loading="lazy">
                <div class="event-overlay">
                    <span class="event-icon">🔍</span>
                    <p>點擊放大</p>
                </div>
